...
- RESET button in header to clear all settings and start fresh
- Donation modal that appears after 3 CSS exports/copies
  - Shows Ko-fi and PayPal donation options
  - Users can continue without donating
- Export count tracking via cookies (persists across sessions)
